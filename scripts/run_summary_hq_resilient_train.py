...
def main() -> None:
    parser = argparse.ArgumentParser(description="Resilient summary trainer for RTX 3080")
    parser.add_argument("--model-path", required=True)
    parser.add_argument("--data", nargs="+", required=True)
    parser.add_argument("--output-root", default="outputs/summary_hqcorr_resilient")
    parser.add_argument("--logs-dir", default="logs")
    parser.add_argument("--report", default="logs/train_summary_hqcorr_resilient_report.json")
