...
def main() -> None:
    parser = argparse.ArgumentParser(description="Resilient text trainer for RTX 3080")
    parser.add_argument("--model-path", required=True)
    parser.add_argument("--data", nargs="+", required=True)
    parser.add_argument("--output-root", default="outputs/text_resilient")
    parser.add_argument("--logs-dir", default="logs")
    parser.add_argument("--report", default="logs/train_text_resilient_report.json")
    ...
    parser.add_argument("--profile", choices=["first", "non_first"], default="first")
    parser.add_argument("--preset", default="rtx3080_qwen35_4b_safe")
    parser.add_argument("--num-epochs", type=int, default=None)
    parser.add_argument("--dry-run", action="store_true")
    args = parser.parse_args()

    task = "text_first" if args.profile == "first" else "text_nonfirst"
